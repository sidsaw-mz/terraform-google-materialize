...
| <a name="input_environmentd_version"></a> [environmentd\_version](#input\_environmentd\_version) | Version of the Materialize environmentd image | `string` | `"v0.127.1"` | no |
...
| <a name="input_operator_version"></a> [operator\_version](#input\_operator\_version) | Version of the Materialize operator | `string` | `"v25.1.0-beta.1"` | no |
